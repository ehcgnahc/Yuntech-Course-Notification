        ...
        while True:
            try:
                ...
                payload.update({
                    ...
                    "ctl00$MainContent$MajOp$0": "on",
                    "ctl00$MainContent$MajOp$1": "on",
                    "ctl00$MainContent$MajOp$2": "on",
                    "ctl00$MainContent$MajOp$3": "on",
                    "ctl00$MainContent$MajOp$4": "on",
                    "ctl00$MainContent$MajOp$5": "on",
                    "ctl00$MainContent$MajOp$6": "on",
                    "ctl00$MainContent$MajOp$7": "on",
                    "ctl00$MainContent$MajOp$8": "on",
                    "ctl00$MainContent$MajOp$9": "on",
                ...
                while True:
                    ...
                    if ajax_response.status_code == 200:
                        ...
                        if table:
                            for row in table.find_all("tr")[1:]:
                                ...
                                if len(cols) >= 11:
                                    ...
                                    info = (targetSemester, course_ID, course_cname, course_type, current_students, max_limit)
                        ...
                        print(f"Page {current_page + 1} Success, {end - start:.2f}s")
                    else:
